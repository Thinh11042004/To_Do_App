        ...
        builder: (_, setBtm) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ Chỉ cần để nội dung ở đây, KHÔNG lặp mainAxisSize/children nữa
              SwitchListTile(
            ...
            for (final cfg in configs)
              ListTile(
                leading: CircleAvatar(
                  backgroundColor: Color(cfg.color),
                  radius: 8,
                ),
                title: Text(cfg.label),
                trailing:
                    cfg.id == _customCategoryId ||
                        (_categoryStore.resolveSystem(cfg.id) == _category &&
          ...
          Row(
            children: [
              ...
              TextButton.icon(
                ...
                onPressed: () =>
                    Navigator.of(context).pushNamed('/templates').then((value) {
                      if (value is Task) {
                        setState(() {
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              onPressed: () {
                                ...
                                setState(() {
                                  _subs.add(
                                    SubTask(title: _subCtl.text.trim()),
                                  );
                                  _subCtl.clear();
                                });
                              },
